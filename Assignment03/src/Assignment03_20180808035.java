...
public class Assignment03_20180808035 {
    public static void main(String[] args) {
        ...
        //Test code for Assignment 03
        Collection<Transaction> ts = new ArrayList<Transaction>();
        ts.add(new Transaction(3, "4567", "3457",3000));
        // below commented line is a sample invalid transaction type
        // ts.add(new Transaction(2, "4567", 4000));
        ts.add(new Transaction(1, "3457", "4567",1000));
...
class Transaction{
    ...
    public Transaction(String accountNo) {
        ...
        switch (getType()) {
            case 1 : to = accountNo; break;
            case 3 : from = accountNo; break;
            default: throw new InvalidAmountException();
        }
    }
...
class Bank{
    ...
    public void processTransactions(Collection<Transaction> transactions,String outFile) {
        List<Transaction> list = new ArrayList<Transaction>(transactions);

        Comparator<Transaction> compare = Comparator.comparing(Transaction::getType);
        compare.thenComparing(Transaction::getTo);
        compare.thenComparing(Transaction::getFrom);
        compare.thenComparing(Transaction::getAmount);
        ...
        try {
            ...
            try {
                ...
                fileWriter.write("ERROR OCCURRED : "+e.toString());
                fileWriter.close();
